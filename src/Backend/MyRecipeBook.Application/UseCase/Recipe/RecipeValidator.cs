...
namespace MyRecipeBook.Application.UseCase.Recipe;
...
public class RecipeValidator : AbstractValidator<RequestRecipeJson>
{
    public RecipeValidator()
    {
        ...
        {
            instructionRule.RuleFor(i => i.Step).GreaterThan(0).WithMessage(ResourceMessagesException.GREATER_THAN_ZERO_INSTRUCTION_STEP);
            instructionRule.RuleFor(i => i.Text)
