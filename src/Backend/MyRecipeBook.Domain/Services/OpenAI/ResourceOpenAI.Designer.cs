...
namespace MyRecipeBook.Domain.Services.OpenAI {
    ...
    public class ResourceOpenAI {
        ...
        /// <summary>
        ///   Looks up a localized string similar to You are a chef who knows many tasty recipes. When the user provides you with a list of ingredients separated by &apos;;&apos;, you will respond with just one recipe that is easy to create with the given ingredients.
        ///
