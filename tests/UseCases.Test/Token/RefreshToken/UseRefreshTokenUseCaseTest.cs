...
using MyRecipeBook.Application.UseCase.Token.RefreshToken;
...
public class UseRefreshTokenUseCaseTest
{
    ...
    public static UseRefreshTokenUseCase CreateUseCase(MyRecipeBook.Domain.Entities.RefreshToken? refreshToken = null)
    {
