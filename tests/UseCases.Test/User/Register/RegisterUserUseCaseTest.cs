...
public class RegisterUserUseCaseTest
{
    ...
    private static RegisterUserUseCase CreateUseCase(string? email = null)
    {
        ...
        return new RegisterUserUseCase(writeOnlyRepository, readOnlyRepositoryBuilder.Build(), mapper, passwordEncripter, unitOfWork, accessTokenGenerator, refreshTokenCreator);
    }
}